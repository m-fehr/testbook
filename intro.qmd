...
![JURECA supercomputer. Source: Forschungszentrum Jülich](https://www.fz-juelich.de/en/ias/jsc/systems/supercomputers/jureca/jureca-dc.jpeg/@@images/image){#fig-jureca width="80%"}
...
<!-- Thats the way videos should be included:
{{< video https://uni-wuppertal.sciebo.de/s/nVLI1zYV20rBESP/download
    title="Simulation of fires in an underground station, part of the [ORPHEUS project](http://www.orpheus-projekt.de), using the software [FDS](https://pages.nist.gov/fds-smv/)."
>}} -->
<!-- 
...
|:--:|
| Self-consistent simulation of fire spread along a cable route, part of @Hehnen.2020. Calculated with [FDS](https://pages.nist.gov/fds-smv/). | -->